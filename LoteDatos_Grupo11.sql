...
(1, 'Primera temporada del atraco.', 3),
(2, 'Segunda temporada del atraco.', 3);
...
('El Comienzo', 1, 50, 'Inicio del atraco.', 1, 3),
('El Caos', 2, 55, 'Problemas dentro de la Fábrica.', 1, 3),
('El Final', 1, 60, 'Desenlace de la historia.', 2, 3);
